...
SET CLANG_AST_EXPORT_SOURCE_DIR=%CLANG_AST_EXPORT_GIT_ROOT%\source
SET CLANG_AST_EXPORT_LIB_SOURCE_DIR=%CLANG_AST_EXPORT_SOURCE_DIR%\ast_export
SET CLANG_AST_EXPORT_EXE_SOURCE_DIR=%CLANG_AST_EXPORT_SOURCE_DIR%\ast_export